...
public class HomeController : Controller
{
    public IActionResult Index()
    {
        var viewModel = new HomeViewModel
        {
            ...
            {
                new("Gian Bernardino", "Lead Vocals"),
                new("Raphaell Ridao", "Lead Vocals"),
                new("Gabriel Fernandez", "Lead Guitar"),
                new("CJ Fernandez", "Rhythm Guitar"),
                new("Xen Gareza", "Keyboardist")
            },
            Discography = new List<Album>
            {
                new("Patutunguhan", "Single", "2023", "https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?q=80&w=500"),
                new("Ikaw Pa Rin Ang Pipiliin Ko", "Single", "2023", "https://images.unsplash.com/photo-1493225255756-d9584f8606e9?q=80&w=500"),
